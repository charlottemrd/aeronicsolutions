...
<head>
    ...
    <meta charset="utf-8"/>
    <link rel="stylesheet" href="../public/css/presentationTest.css"/>
</head>
    ...
    <div class="test">
        <div class="bloc">
            ...
            <div class="contenu">
                ...
                <div class="image">
                    <img src="../public/images/température.jpg" alt="©LeDevoir">
                </div>
            </div>
        </div>
        ...
        <div class="bloc">
            ...
            <div class="contenu">
                ...
                <div class="image">
                    <img src="../public/images/audition.jpg" alt="©futura-sciences">
                </div>
            </div>
        </div>
        ...
        <div class="bloc">
            ...
            <div class="contenu">
                ...
                <div class="image">
                    <img src="../public/images/oeil.jpg" alt="©FYidoctors">
                </div>
            </div>
        </div>
        ...
        <div class="bloc">
            ...
            <div class="contenu">
                ...
                <div class="image">
                    <img src="../public/images/fréquenceCardiaque.jpg" alt="©freepik">
                </div>
            </div>
        </div>
    </div>
