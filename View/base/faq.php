...
<div class="contentfaq">
    ...
    <div class="questions">
        ...
        <div class="title_partie">
            <h3>Modification - supression du profil</h3>
        </div>
        ...
        <div class ="reponses" id="reponse4" >
            <h3>Vous pouvez changer votre mot de passe, nom, prénom et date depuis la page gestion du profil</h3>
        </div>
        ...
        <div class ="reponses" id="reponse5" >
            <h3>Vous ne pouvez pas modifier votre adresse e-mail de vous-même, nous vous invitons à prendre contact avec un administrateur de Aeronic Solutions pour le faire</h3>
        </div>
        ...
        <div class ="reponses" id="reponse6" >
            <h3>Si vous n'êtes pas satisfait des prestations offerts par Aeronic Solutions, vous pouvez adresser un mail à solutionsaeronic@gmail.com afin que votre compte et donnée ass</h3>
        </div>
        ...
        <div class="questions">
            <button class="bouton" id="buttonr8" onclick="changeVisibility('reponse8')"  >Est-il possible de connaitre le déroulement d'un test Aeronic Solutions?</button>
        </div>
        <div class ="reponses" id="reponse8" >
            <h3>Afin que vous ne soyez pas déstabilisé la première fois que vous passé une série de tests, nous vous avons mis à disposition un résumé des tests ainsi que l'ordre de ces derniers depuis la page information sur les tests</h3>
        </div>
    </div>
