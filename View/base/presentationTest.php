    ...
    <div class="test">
        ...
        <div class="bloc">
            ...
            <div class="contenu">
                ...
                <video src="../assets/Ressources/Videos/IMG_9393.MOV" autoplay loop >
        ...
        <div class="bloc">
            ...
            <div class="contenu">
                ...
                <video src="../assets/Ressources/Videos/IMG_9401.MOV" autoplay loop >
                        Le fichier ne peut pas être lu
                </video>
            </div>
        </div>
        ...
        <div class="bloc">
            ...
            <div class="contenu">
                ...
                <video src="../assets/Ressources/Videos/IMG_9391.MOV" autoplay loop >
                        Le fichier ne peut pas être lu
                </video>
            </div>
        </div>
